...
int bigger(int, int);
bool isline(char);
std::vector<std::vector<char>> trace(std::vector<std::vector<char>> &, std::vector<std::vector<char>> &);
...
int main() {
    ...
    std::vector<std::vector<char>> field3 = trace(field1, field2);
    ...
    for(int y=0; y<field.size(); y++) {
        for(int x=0; x<field[0].size(); x++) {
            ...
            if(field[y][x] == 'X') {    
                ...
                if(output.first+output.second > temp.first+temp.second) {
                    output.first = temp.first;
                    output.second = temp.second;
                }
                */
...
std::vector<std::vector<char>> trace(std::vector<std::vector<char>> &field1, std::vector<std::vector<char>> &field2) {
